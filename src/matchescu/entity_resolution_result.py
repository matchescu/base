class EntityResolutionResult:
    ...
    @fsm.setter
    def fsm(self, value: list[tuple[tuple]]) -> None:
        self.__fsm = value

    @property
    def serf(self) -> list[tuple]:
    ...
    @serf.setter
    def serf(self, value: list[tuple]) -> None:
        self.__serf = value

    @property
    def algebraic(self) -> list[list[tuple]]:
    ...
    @algebraic.setter
    def algebraic(self, value: list[list[tuple]]) -> None:
